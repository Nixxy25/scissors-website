  ...
  return (
    <div>
        <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-12 mx-20 max-lg:mx-10 max-sm:mx-4 my-4">
            <nav className="flex justify-between items-center">
                <div className="">
                    <svg width="196" className="max-lg:w-32" height="40" viewBox="0 0 156 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center gap-10 max-lg:gap-3 max-sm:hidden">
                ...
                <div className="flex gap-5 max-lg:gap-3 items-center max-sm:hidden">
                ...
                <div className="md:hidden" onClick={handleDropDown}>
                    { dropDown ?
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" viewBox="0 0 384 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/></svg>
                    : <svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="#1E3448" viewBox="0 0 448 512"><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>}
                    
                    {dropDown && (
                        <div className="absolute left-0 p-10 bg-white h-3/5  flex flex-col gap-4 text-lg font-semibold overflow-hidden w-full">
                            <div className="text-blue md:text-sm">My URLs</div>
                            <div className="flex">
                                <div className="text-black">Features</div>
                                <div>
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="text-black md:text-sm">Pricing</div>
                            <div className="text-black md:text-sm">Analytics</div>
                            <div className="text-black md:text-sm">FAQs</div>

                            
                            <div className="flex gap-5 items-center">
                            <div className="text-black md:text-sm">Log In</div>
                            <button className="rounded-full px-5 py-1.5 bg-blue text-white focus:outline-none">Try for free</button>
                            </div>
            ...
            <div className="flex flex-col items-center max-sm:mx-4">
            <div className="text-center items-center flex flex-col gap-8 max-lg:gap-6 w-2/3 max-sm:w-full max-sm:gap-4">
                <h1 className="text-4xl font-bold text-black max-sm:text-2xl max-lg:text-2xl">Optimize Your Online Experience with Our</h1>
                
                <div className="flex text-4xl font-bold gap-2 text-black max-sm:text-2xl max-lg:text-2xl max-sm:flex-col">
                ...
                <div className="text-blue">
                    ...
                    <svg width="174"height="21" className="max-sm:w-32" viewBox="0 0 174 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="mx-20 max-sm:mx-10 max-md:mx-12 max-sm:text-sm max-sm:mx-text-center text-black">Personalize your shortened URLs to align with your brand identity. Utilize custom slugs, branded links, and domain customization options to reinforce your brand presence and enhance user engagement.</h3>
