  ...
  return (
    <div>
        <div className="flex flex-col  gap-12">
            ...
            <div className="flex flex-col gap-12 mx-20 max-sm:mx-4 my-4">
            <nav className="flex justify-between items-center ">
                <div className="">
                    <svg width="196" height="40" viewBox="0 0 156 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="md:hidden" onClick={handleDropDown}>
                    ...
                    {dropDown && (
                        <div className="absolute left-0 p-10 bg-cyan flex flex-col gap-4 text-lg font-semibold h-screen w-full">
                            <div className="text-blue ">My URLs</div>
                            <div className="flex">
                                <div className="text-black">Features</div>
                                <div>
